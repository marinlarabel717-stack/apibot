...
ASIA_COUNTRY_TRANSLATIONS: list[tuple[str, str]] = [
    ("中国", "China"),
    ("香港", "Hong Kong"),
    ("澳门", "Macau"),
    ("台湾", "Taiwan"),
...
WESTERN_COUNTRY_TRANSLATIONS: list[tuple[str, str]] = [
    ("美国", "United States"),
    ("加拿大", "Canada"),
    ("墨西哥", "Mexico"),
    ("古巴", "Cuba"),
...
AFRICA_COUNTRY_TRANSLATIONS: list[tuple[str, str]] = [
    ("埃及", "Egypt"),
    ("阿尔及利亚", "Algeria"),
    ("摩洛哥", "Morocco"),
    ("突尼斯", "Tunisia"),
...
TERRITORY_NAME_TRANSLATIONS: list[tuple[str, str]] = [
    ("法罗群岛", "Faroe Islands"),
    ("直布罗陀", "Gibraltar"),
...
COUNTRY_NAME_TRANSLATIONS: list[tuple[str, str]] = [
    *ASIA_COUNTRY_TRANSLATIONS,
    *WESTERN_COUNTRY_TRANSLATIONS,
    *AFRICA_COUNTRY_TRANSLATIONS,
    *TERRITORY_NAME_TRANSLATIONS,
]

SEARCH_COUNTRY_KEYWORDS = {source for source, _ in COUNTRY_NAME_TRANSLATIONS}
