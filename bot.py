...
SEARCH_COUNTRY_KEYWORDS = {
    ...
    "阿富汗", "印度", "巴基斯坦", "孟加拉", "孟加拉国", "尼泊尔", "斯里兰卡", "不丹", "马尔代夫",
    "哈萨克斯坦", "乌兹别克斯坦", "土库曼斯坦", "吉尔吉斯斯坦", "塔吉克斯坦",
    "亚美尼亚", "爱沙尼亚", "爱莎尼亚", "爱莎你也", "阿塞拜疆", "格鲁吉亚", "摩尔多瓦",
    "塞尔维亚", "阿尔巴尼亚", "阿尔布尼亚", "黑山", "北马其顿", "拉脱维亚", "斯洛文尼亚",
    "阿联酋", "迪拜", "沙特", "沙特阿拉伯", "卡塔尔", "科威特", "阿曼", "巴林", "也门",
    "伊朗", "伊拉克", "叙利亚", "约旦", "黎巴嫩", "以色列", "巴勒斯坦", "土耳其",
    "埃及", "阿尔及利亚", "摩洛哥", "突尼斯", "利比亚", "南苏丹", "苏丹",
    "尼日利亚", "尼日尔", "加纳", "刚果金", "刚果", "贝宁", "多哥", "肯尼亚", "乌干达", "坦桑尼亚", "埃塞俄比亚", "卢旺达", "几内亚", "赤道几内亚", "几内亚比绍", "马达加斯加",
    "南非", "赞比亚", "津巴布韦", "安哥拉", "喀麦隆", "科特迪瓦", "塞内加尔",
    "美国", "加拿大", "墨西哥", "古巴", "牙买加", "波多黎各", "多米尼加", "多米尼克", "海地", "巴哈马", "巴巴多斯",
    "格林纳达", "圣卢西亚", "圣基茨和尼维斯", "圣文森特和格林纳丁斯", "安提瓜和巴布达", "特立尼达和多巴哥",
    "伯利兹", "危地马拉", "洪都拉斯", "尼加拉瓜", "萨尔瓦多", "巴拿马", "哥斯达黎加", "圣皮埃尔",
    "巴西", "阿根廷", "智利", "哥伦比亚", "秘鲁", "委内瑞拉", "玻利维亚", "巴拉圭", "乌拉圭", "厄瓜多尔", "圭亚那", "苏里南",
    "英国", "爱尔兰", "法国", "德国", "意大利", "西班牙", "葡萄牙", "荷兰", "比利时", "卢森堡",
    "瑞士", "奥地利", "波兰", "捷克", "匈牙利", "罗马尼亚", "希腊", "瑞典", "挪威",
    "芬兰", "丹麦", "冰岛", "乌克兰", "俄罗斯", "白俄罗斯", "法罗群岛", "直布罗陀",
    "澳洲", "澳大利亚", "新西兰", "巴布亚新几内亚", "法属波利尼西亚", "法属玻利尼西亚", "瓜德罗普", "马提尼克",
    "留尼汪", "新喀里多尼亚", "法属圭亚那", "库拉索", "阿鲁巴", "开曼群岛", "百慕大", "关岛", "美属萨摩亚",
}
...
CATEGORY_NAME_TRANSLATIONS: list[tuple[str, str]] = [
    ...
    ("欧美地区", "Western Region"),
    ("非洲地区", "Africa Region"),
    ("精养月号", "Premium Monthly Account"),
    ("最新渠道", "Latest Channel"),
    ("月号-年号", "Monthly-Yearly Account"),
    ("月号", "Monthly Account"),
    ("满月", "Full Month"),
    ("实卡", "Physical Card"),
    ("2-5个月", "2-5 Months"),
